...
describe("ContextStorage", () => {
  let storage: ContextStorage<TestContext>;
  ...
  describe("constructor", () => {
    it("should create a ContextStorage instance with default name", () => {
      const defaultStorage = new ContextStorage(contextFactory);
      expect(defaultStorage).toBeDefined();
    });

    it("should create a ContextStorage instance with custom name", () => {
      const customStorage = new ContextStorage(contextFactory, "CustomContext");
  ...
  describe("runWithContext", () => {
    ...
    it("should isolate context between different runs", () => {
      let firstContext: TestContext | null = null;
      let secondContext: TestContext | null = null;
  ...
  describe("context isolation", () => {
    it("should maintain separate contexts for nested calls", () => {
      let outerContext: TestContext | null = null;
      let innerContext: TestContext | null = null;
